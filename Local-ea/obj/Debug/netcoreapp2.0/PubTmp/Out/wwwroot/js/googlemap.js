    ...
    for (var i = 0; i < userDb.length; i++) {
        ...
        //' + anim + '   ---   onclick="mvsanimation()"
            ...
            snipet =
                ...
                <div id="info-avatar" style="20%"><img src="\\img\\Avatars\\'+ userDb[i]["avatar"] +'" class="avatar avatar-image rounded-circle img-fluid" /><a id="but" onclick="mvsanimation(this)" title="Send Message Now!" class= "btn btn-outline-danger btn-sm chat-with-me-map"  data-avatar="' + userDb[i]["avatar"] + '" data-name="' + userDb[i]["userNameStr"] + '" data-id="' + userDb[i]["id"] + '" > Chat</a ></div >      \
                </div > ']
        }
